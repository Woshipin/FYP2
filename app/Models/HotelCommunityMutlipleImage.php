...
class HotelCommunityMutlipleImage extends Model
{
    use HasFactory;

    protected $fillable = ['community_id', 'image_path'];

    // Define the relationship with the HotelCommunity model
    public function community()
    {
        return $this->belongsTo(HotelCommunity::class, 'community_id');
    }
