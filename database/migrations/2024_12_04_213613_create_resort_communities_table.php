...
return new class extends Migration
{
    ...
    {
        Schema::create('resort_communities', function (Blueprint $table) {
            $table->id();
            $table->foreignId('resort_id')->constrained('resorts'); // Foreign key to resorts
    ...
    {
        Schema::dropIfExists('resort_communities');
    }
};
