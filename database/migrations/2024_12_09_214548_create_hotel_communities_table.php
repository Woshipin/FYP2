...
return new class extends Migration
{
    ...
    {
        Schema::create('hotel_communities', function (Blueprint $table) {
            $table->id();
            $table->foreignId('hotel_id')->constrained('hotels'); // Foreign key to resorts
    ...
    {
        Schema::dropIfExists('hotel_communities');
    }
};
