                    ...
                    <div class="left">
                        ...
                        <div class="ticket-info">
                            <div class="ticket-date">
                                <span
                                    class="month-day">{{ \Carbon\Carbon::parse($restaurant->booking_date)->format('l') }}</span>
                                <span
                                    class="month-day">{{ \Carbon\Carbon::parse($restaurant->booking_date)->format('j F') }}</span>
                                <span
                                    class="month-day">{{ \Carbon\Carbon::parse($restaurant->booking_date)->format('Y') }}</span>
                            </div>
                        ...
                        <div class="right-info-container">
                            <div class="ticket-time">
                                <div class="time-item">
                                    ...
                                    <span
                                        class="time-value">{{ \Carbon\Carbon::parse($restaurant->checkin_time)->format('g:i A') }}</span>
                                </div>
                                <div class="time-item">
                                    <span class="time-label">Check Out:</span>
                                    <span
                                        class="time-value">{{ \Carbon\Carbon::parse($restaurant->checkout_time)->format('g:i A') }}</span>
                                </div>
                            </div>
                            <div class="ticket-barcode">
                                ...
                                $url =
                                    ...
                                    $ipAddress .
                                    ':8000' .
                                    route('verify.restaurant', ['restaurantId' => $restaurant->id], false) .
                                    '?' .
                                    http_build_query([
                            ...
                            <div class="action-buttons">
                                ...
                                @if ($restaurant->payment_status == 0)
                                    <form action="{{ route('booking.cancel.restaurant', $restaurant->id) }}"
                                        method="POST">
                                        @csrf
                                        <button type="submit"
                                ...
                                @elseif($restaurant->payment_status == 1)
                                    <form action="{{ route('booking.checkout.restaurant', $restaurant->id) }}"
                                        method="POST">
                                        @csrf
                                        <button type="submit"
