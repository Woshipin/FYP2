                    ...
                    <div class="left">
                        <div class="image">
                            @if ($hotel->hotel->images->count() > 0)
                                <img src="{{ asset('images/' . $hotel->hotel->images->first()->image) }}" class="ticket-image"
                                    alt="Hotel Image">
                            @else
                        ...
                        <div class="ticket-info">
                            <div class="ticket-date">
                                <span
                                    class="month-day">{{ \Carbon\Carbon::parse($hotel->booking_date)->format('Y') }}</span>
                                <span
                                    class="month-day">{{ \Carbon\Carbon::parse($hotel->booking_date)->format('F j') }}</span>
                                <span
                                    class="month-day">{{ \Carbon\Carbon::parse($hotel->booking_date)->format('l') }}</span>
                            </div>
                        ...
                        <div class="right-info-container">
                            <div class="ticket-time">
                                <div class="time-item">
                                    ...
                                    <span
                                        class="time-value">{{ \Carbon\Carbon::parse($hotel->checkin_date)->format('j F Y') }}</span>
                                </div>
                                <div class="time-item">
                                    <span class="time-label">Check-Out Date:</span>
                                    <span
                                        class="time-value">{{ \Carbon\Carbon::parse($hotel->checkout_date)->format('j F Y') }}</span>
                                </div>
                                <div class="time-item">
                                    <span class="time-label">Check-In Time:</span>
                                    <span
                                        class="time-value">{{ \Carbon\Carbon::parse($hotel->checkin_time)->format('g:i A') }}</span>
                                </div>
                                <div class="time-item">
                                    <span class="time-label">Check-Out Time:</span>
                                    <span
                                        class="time-value">{{ \Carbon\Carbon::parse($hotel->checkout_time)->format('g:i A') }}</span>
                                </div>
                            </div>
                            <div class="ticket-barcode">
                                ...
                                $url =
                                    ...
                                    $ipAddress .
                                    ':8000' .
                                    route('verify.hotel', ['hotelId' => $hotel->id], false) .
                                    '?' .
                                    http_build_query([
