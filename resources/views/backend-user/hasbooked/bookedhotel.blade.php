    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <form action="{{ route('hashotelSearch') }}" method="GET"
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control bg-white small m-2" name="hotel_name"
                            placeholder="Hotel Name" aria-label="Search" aria-describedby="basic-addon2">
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered">
                            ...
                            <button type="submit" class="btn btn-danger m-1" id="deleteAllSelectedRecord">Delete All
                                Selected Booked Hotels</button>

                            {{-- Export Booked Hotel --}}
                            <a href="{{ url('export-bookedHotel') }}"><button type="button"
                                    class="btn btn-primary m-1">Export Booked Hotels</button></a>
                                ...
                                @if ($hotelbookeds !== null && count($hotelbookeds) > 0)
                                    @foreach ($hotelbookeds as $hotel)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('viewBookedHotel/' . $hotel->id) . '/view' }}"
