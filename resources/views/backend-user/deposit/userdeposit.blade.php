                    ...
                    <div class="modal-body">
                        ...
                        <div class="container-payment">
                            ...
                            <div class="inputBox">
                                ...
                                <input type="text" id="card_number" value="" name="card_number" maxlength="16"
                            ...
                            <div class="flexbox">
                                ...
                                <div class="inputBox">
                                    <span>cvv</span>
                                    <input type="number" name="cvv" maxlength="4" value=""
                                        class="cvv-input">
                                </div>
                            </div>
        ...
        <div class="modal fade" id="refunduserdepositModal{{ $userdeposit->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ url('/RefundDepositToUser/' . $userdeposit->id) }}" method="POST"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="container-payment">
                                ...
                                <div class="inputBox">
                                    <span>Customer Name</span>
                                    <input type="text" id="customer_name" value="{{ $userdeposit->user_name }}"
                                        name="customer_name" required>
                                </div>

                                <div class="inputBox">
                                    <span>User Booked Type Name</span>
                                    <input type="text" id="type_name" value="{{ $userdeposit->type_name }}"
                                        name="type_name" required>
                                </div>

                                <div class="inputBox">
                                    <span>User Card Number</span>
                                    <input type="text" id="card_number" value="{{ $userdeposit->card_number }}"
                                        name="card_number" maxlength="16" class="card-number-input"
                                ...
                                <div class="inputBox">
                                    <span>Card Number</span>
                                    <input type="text" id="my_card_number" value="" name="my_card_number"
                                        maxlength="16" class="card-number-input" placeholder="0000 0000 0000 0000"
                                        required>
                                </div>
                                ...
                                <div class="flexbox">
                                    ...
                                    <div class="inputBox">
                                        <span>cvv</span>
                                        <input type="text" name="cvv" maxlength="4" value=""
                                            class="cvv-input">
                                    </div>
                                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <form action="{{ route('DepositSearch') }}" method="GET"
                    class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                    <div class="input-group">
                        <input type="text" class="form-control bg-white small m-2" name="user_name"
                            placeholder="Search for User Name" aria-label="Search" aria-describedby="basic-addon2">
                    ...
                    <form action="{{ route('resorts.deleteMultipledeposit') }}" method="post" id="deleteMultipleForm">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-striped table-bordered">
                                ...
                                {{-- Export Resort --}}
                                <a href="{{ url('export-deposit') }}"><button type="button"
                                        class="btn btn-primary m-1">Export Deposit</button></a>
