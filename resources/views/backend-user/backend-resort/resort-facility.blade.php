    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title">Facilities for {{ $resort->name }}</h1>
                <p class="card-description">Select the available facilities for this resort</p>
            </div>
            <div class="card-content">
                <form action="{{ url('backend-user/backend-resort/resortfacility/' . $resort->id . '/add-facilities') }}" method="POST">
                    @csrf
