...
<div class="modal fade" id="tableexcelModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form action="{{ route ('tables.deleteMultipletable') }}" method="post" id="deleteMultipleForm">
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered">
                            {{-- Button to delete all selected items --}}
                            <button type="submit" class="btn btn-danger m-1" id="deleteAllSelectedRecord">Delete All Selected Tables</button>
                            {{-- Add Resort --}}
                            <button type="button" class="btn btn-info m-1" data-toggle="modal" data-target="#tableModal">Add Table</button>
                            <!-- Import Table Model -->
                            <button type="button" class="btn btn-primary m-1" data-toggle="modal" data-target="#tableexcelModal">Import Table</button>
                            {{-- Export Resort --}}
                            <a href="{{ url('export-table') }}"><button type="button" class="btn btn-primary m-1">Export Table</button></a>
                            {{-- Table Excel Template --}}
                            <a href="{{ route('Table.Excel.Template') }}"><button type="button" class="btn btn-dark m-1">Table Excel Template</button></a>
                            ...
                            <tbody>
                                @if($tabless !==null && count($tabless) > 0)
                                    @foreach ($tabless as $table)
                                        <tr>
                                            <td><input type="checkbox" name="ids" class="checkbox_ids" id="" value="{{ $table->id }}"></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tableeditModal{{ $table->id }}"><i class="fa fa-edit"></i>&nbsp;Edit</a>
                                                <a onclick="return confirm('Are you sure to delete this data?')" href="{{ url('deleteTable/'.$table->id).'/delete' }}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
