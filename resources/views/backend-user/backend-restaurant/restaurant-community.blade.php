...
@section('newuser-section')
    ...
    <div class="container">
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#restaurantModal">
            Add New Restaurant Community
        </button>
                    ...
                    <div class="community-content">
                        ...
                        <div class="action-icons">
                            ...
                            <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                data-bs-target="#restaurantEditModal{{ $community->id }}">
                                <i class="fa fa-edit"></i>&nbsp;Edit
                            </a>

                            <!-- Delete button -->
                            <a onclick="return confirm('Are you sure to delete this data?')"
                                href="{{ route('restaurant.community.delete', $community->id) }}" class="btn btn-danger btn-sm">
            ...
            <div class="modal-dialog modal-lg" role="document"> <!-- 使用modal-lg类来增加宽度 -->
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="restaurantModalLabel">Add New Restaurant Community</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="restaurantForm" action="{{ route('restaurant.community.save', ['id' => $id]) }}" method="POST"
        ...
        @foreach ($communities as $community)
            <div class="modal fade" id="restaurantEditModal{{ $community->id }}" tabindex="-1" role="dialog"
                aria-labelledby="restaurantEditModalLabel{{ $community->id }}" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="restaurantEditModalLabel{{ $community->id }}">
                                Edit Community
                            </h5>
                        ...
                        <div class="modal-body">
                            <form id="restaurantEditForm{{ $community->id }}"
                                action="{{ route('restaurant.community.update', $community->id) }}" method="POST"
                                enctype="multipart/form-data">
