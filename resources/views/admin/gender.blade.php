...
@section('admin-section')
    ...
    @foreach ($genders as $gender)
        ...
        <div class="modal fade" id="gendereditModal{{ $gender->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ url('admin/updateGender/' . $gender->id) }}" method="POST"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ url('admin/editGender/' . $gender->id) . '/edit' }}"
                                                        ...
                                                        data-target="#gendereditModal{{ $gender->id }}"><i
