...
<head>
    <title>Booked Hotel Email</title>
...
<body>
    <div class="invoice">
        ...
        <div class="details">
            ...
            <p>Check-Out-Time: <span>{{ \Carbon\Carbon::parse($check_out_time)->format('g:i A') }}</span></p>
        </div>
        ...
        <div class="footer">
            ...
            <p>If any problem, you can contact phone number ({{ $hotel_phone }}) or email
                ({{ $hotel_email }}), for your purchase! Enjoy the Hotel!</p>
        </div>
