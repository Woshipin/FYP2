...
@section('frontend-section')
    ...
    <div class="back-arrow-circle">
        <a href="{{ route('hotel-detail', ['id' => $hotels->id]) }}">
    ...
    <section class="contact" id="contact">
        ...
        <div class="row">
            ...
            <form action="{{ url('contacthotel') }}" method="post" class="contact-form">
                @csrf

                <input type="hidden" name="name" value="{{ auth()->user()->name }}">
                <input type="hidden" name="email" value="{{ auth()->user()->email }}">

                <input type="hidden" name="ownertype" value="{{ $hotels->name }}">
                <input type="hidden" name="ownername" value="{{ $hotels->user->name }}">
