...
@section('frontend-section')
    ...
    <div class="container">
        ...
        <div class="hotel-header">
            <div>
                <h1 class="hotel-title" id="detail">{{ $hotels->name }}</h1>
                <div class="hotel-location">
                    <i class="fas fa-map-marker-alt"></i>
                    <span id="detail">{{ $hotels->address }}</span>
                </div>
            </div>
        </div>
                ...
                <div class="image-gallery">
                    @if ($hotels->images->isNotEmpty())
                        ...
                        <div class="main-image-container">
                            <img src="{{ asset('images/' . $hotels->images->first()->image) }}" alt="Hotel view"
                                class="main-image">
                        </div>
                        <!-- 缩略图网格 -->
                        <div class="thumbnail-grid">
                            @foreach ($hotels->images->slice(1, 10) as $image)
                                <div class="thumbnail">
                                    <img src="{{ asset('images/' . $image->image) }}" alt="Hotel view"
                                        onclick="show360Image('{{ asset('images/' . $image->image) }}')">
                                    <!-- 如果是第10张图片，显示 View More -->
                                    @if ($loop->index == 9 && $hotels->images->count() > 10)
            ...
            <div class="info-column">
                <div class="info-card">
                    ...
                    <div class="action-buttons">
                        <a href="{{ url('bookinghotel/' . $hotels->id) }}" class="btn btn-primary" id="btn">
                            <i class="fas fa-calendar-check"></i>
                            Book Now
                        </a>

                        <a href="{{ route('hotels.usercontact', ['id' => $hotels->id]) }}" class="btn btn-primary" id="btn">
                ...
                <div class="rating-modal">
                    ...
                    <form action="{{ route('hotelratings') }}" method="POST" class="rating-form">
                        @csrf
        ...
        <div class="columns">
            <!-- Comments Column -->
            <div class="column">
                <a href="{{ route('hotels.comment', ['id' => $hotels->id]) }}">
            ...
            <div class="column facility-column" id="facility-column">
                ...
                <div class="column-content">
                    ...
                    <p>Hotel facilities and amenities details</p>
                </div>
            </div>
        ...
        <div class="map-section">
            <iframe src="{{ $hotels->map }}" class="map-frame" allowfullscreen></iframe>
        </div>
        ...
        <div id="imageModal" class="modal">
            <div class="modal-content">
                ...
                <div class="modal-thumbnail-grid">
                    @foreach ($hotels->images->slice(10) as $image)
        ...
        <div id="community-modal" class="community-modal">
            <div class="community-modal-content">
                <div class="community-modal-header">
                    <h2>{{ $hotels->name }}<span class="community-stars">
                            @for ($i = 1; $i <= 5; $i++)
                ...
                <div class="community-modal-body">
                    ...
                    <div class="community-info-container">
                        <p class="community-address" id="detail"><span
                                class="community-icon">📍</span>{{ $hotels->address }}</p>
                        <div class="community-rating">
                            <span class="community-rating-score">{{ $averageRating ?? '0' }}</span>
                            {{-- <span class="community-rating-text">{{ $hotels->location }}</span> --}}
        ...
        <div id="facility-modal" class="facility-modal">
            <div class="facility-modal-content">
                <div class="card-header">
                    <h2 class="card-title">{{ $hotels->name }} Facility</h2>
                    <span class="facility-close">&times;</span>
                </div>
                <div class="card-content">
                    <div class="facilities-grid">
                        @foreach ($hotels->facilities as $facility)
