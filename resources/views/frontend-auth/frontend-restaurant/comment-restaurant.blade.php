            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{ route('comments.store', ['id' => $restaurantId]) }}" id="comment-form"
                            method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="well">
                                ...
                                <div style="margin-left:10px;">
                                    ...
                                    <a onclick="return confirm('Are you sure to delete this Comment?')"
                                        href="{{ url('deleteComment/' . $comment->id) . '/delete' }}" style="cursor: pointer;"
                                                ...
                                                <div class="well">
                                                    ...
                                                    <div style="margin-left:10px;">
                                                        ...
                                                        <a onclick="return confirm('Are you sure to delete this Reply?')"
                                                            href="{{ url('replies/' . $reply->id) . '/delete' }}"
