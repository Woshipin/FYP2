        ...
        $(document).ready(function() {
            ...
            $(".resort-comment-list").on("click", ".reply-to-reply", function() {
                ...
                var form =
                    ...
                    '"><input type="hidden" name="parent_id" value="' + parentId +
                    '"><input type="hidden" name="parent_type" value="' + parentType +
                    '"><div class="form-group"><textarea class="form-control" name="reply" placeholder="Enter your reply to ' +
                    rname +
                    '" > </textarea> </div> <div class="form-group"> <input class="btn btn-primary" type="submit"> </div></form>';
