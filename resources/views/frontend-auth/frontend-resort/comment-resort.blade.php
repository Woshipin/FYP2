...
<script>
    $(document).ready(function() {
        ...
        $(".resort-comment-list").on("click", ".reply", function() {
            ...
            appendReplyForm(well, "{{ route('replyresortcomment') }}", cid, name, token, parentId, parentType);
        });
        ...
        $(".resort-comment-list").on("click", ".reply-to-reply", function() {
            ...
            var parentId = $(this).data('parent-id');
            var parentType = $(this).data('parent-type');
            appendReplyToReplyForm(well, "{{ route('storeReplyToReply') }}", rid, rname, token, parentId, parentType);
        });
    });
</script>
